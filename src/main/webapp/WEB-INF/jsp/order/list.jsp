...
<div class="wrapper" style="background-color: transparent;height: 100%" >
        <div class="row J_mainContent" id="content-main" style="height: 100%">
            <iframe class="J_iframe" name="mainFrame" width="100%" height="100%" src="<%=path%>/index/goAddSale" frameborder="0" data-id="index/goAddSale" seamless></iframe>
        </div>
</div>
