var curRow, curCol, loading, SYSTEM = system = parent.SYSTEM,
    ...
    THISPAGE = {
        ...
        initDom: function(a) {
            ...
            var e = '<!--<a id="original" class="ui-btn ui-btn-sc">选择源单</a>--><!--<a id="savaAndAdd" class="ui-btn ui-btn-sp">保存并新增1</a>--><a id="save" class="ui-btn ui-btn-sp">保存</a>',
                ...
                afterEditCell: function(a, b, c, d, e) {
                    function f() {
                        ...
                        if (b) {
                            ...
                            b = $.extend(!0, {}, b), b.mainUnit = c.mainUnit, b.unitId = c.unitId, b.qty = c.qty,
                                b.price = c.price, b.discountRate = c.discountRate, b.deduction = c.deduction, b.amount = c.amount,
                                b.taxRate = c.taxRate, b.tax = c.tax, b.taxAmount = c.taxAmount,
                                b.locationName = c.locationName, $("#" + a).data("goodsInfo", b)
                        }
                    }
        ...
        getPostData: function(a) {
            ...
            if (f.length > 0) {
                var g = $.trim(b.$_note.val()),
                    h = {
                        date: $.trim(b.$_date.val()),//付款日期
                        billNo: $("#billNo").val(),//销款单号
                        selectNo:$("#selectNo").val(),//单据号
